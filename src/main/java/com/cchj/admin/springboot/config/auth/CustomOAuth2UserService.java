...
import com.cchj.admin.springboot.config.auth.dto.OAuthAttributes;
import com.cchj.admin.springboot.config.auth.dto.SessionUser;
import com.cchj.admin.springboot.domain.user.User;
import com.cchj.admin.springboot.domain.user.UserRepository;
...
3. 이후 네이버 로그인과 구글 로그인을 동시 지원할 때 사용
OAuthAttributes
